        ...
        if (event == "telemetry") {
          ...
          for (int i = 0;i < sensor_fusion.size();i++) {
            ...
            if (sensed_car_d < (4* (lane_num0 +1)) && sensed_car_d > (4 * lane_num0)) {
              ...
              if (sensed_car_d < (4* (lane_num1 +1)) && sensed_car_d > (4 * lane_num1)) {
                lane1.addCar(this_car);
              } else
                if (sensed_car_d < (4* (lane_num2 +1)) && sensed_car_d > (4 * lane_num2)) {
          ...
          int currentLane = getCurrentLaneNumber(ego_car_d);
          ...
          if (current_lane_obj.hasAheadCar) {
            ...
            if ((target_car.projected_delta_s) < SAFETY_DISTANCE) {
              ego_target_speed = target_car.speed * 2.24 - 0.224;
            }
          }
